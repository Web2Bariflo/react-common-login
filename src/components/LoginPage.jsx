                        ...
                        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                ...
                                <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
                                    <div>
                                        <label htmlFor="phone" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username</label>
                                        ...
                                        {errors.mob && <span className="text-sm font-light text-red-500">Username required</span>}
                                        {errors.mob && errors.mob.type === "maxLength" && <span className="text-sm font-light text-red-500">Max length should be 12</span>}
                                        {errors.mob && errors.mob.type === "minLength" && <span className="text-sm font-light text-red-500">Min length should be 6</span>}
                                    </div>
                                    <div>
                                        ...
                                        {errors.password && <span className="text-sm font-light text-red-500">Password required</span>}
                                    </div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <button type="button" className="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500">Forget Password</button>
                                    </div>
                                    ...
                                    Don’t have an account yet? <span className="font-medium text-primary-600 hover:underline dark:text-primary-500 cursor-pointer" >Register Here</span>
                                    </p>
                                </form>
                                <Link to='/change-language' className='text-sm mt-0 text-gray-500'>Change Language</Link>
                            </div>
                        </div>
                    </div>
